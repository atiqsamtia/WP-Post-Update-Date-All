...
This Plugin also takes care of the same time and updates the time with the **random** value ranging from current time and 30 minutes in the past.
...
After you have installed the plugin, activate the plugin and go to Settings >> Bulk Post Update Date and click Refresh
...
=Can you modifyt he plugin accordong to my needs?=
